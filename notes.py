...
class Dog:
    #function that start with __(double underscore) are not intended to be called directly
    def __init__(self, fc = "", a = 0, w= 0.0, n = "")-> None: #java version is this. to denote you are talking about the object at hand the -> None means that nothing is being returned. 
    ...
    def __str__(self) -> str:
        s = "Dog's name is " + self.name + "\n" #"\n" is the equivalent to pressing enter to move to the next line
